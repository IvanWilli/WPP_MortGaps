...
mortality_patterns_SVDcomp <- function(model_inputs, 
  ...
  # source(paste0(root_dir,"LifeTables/MLT/R/lt_model_hiv_SVDcomp.R"))
  
  lts_svd <- lt_model_hiv_SVDcomp(inputs = model_inputs, # a data frame with time_start, time_span, sex, q5, q1, q1545, hiv and art)
                                   adjust_oldage_lc = ifelse(!is.na(adjust_oldage_lc), adjust_oldage_lc, FALSE), # whether to use pre-hiv lee-carter extrapolations for older ages
...
mortality_patterns_LogQuad <- function(inputs_type, model_inputs) {
      
  source(paste0(root_dir,"LifeTables/MLT/R/lt_model_lq_single.R"))
...
mortality_patterns_classicMLT <- function(model_region, inputs_type, model_inputs) {
  
  # source(paste0(root_dir,"LifeTables/MLT/R/lt_model_cdun_match_single.R"))
  # source(paste0(root_dir,"LifeTables/MLT/R/lt_model_cdun_combin_single.R"))
  # source(paste0(root_dir,"LifeTables/MLT/R/lt_model_un_bestft.R"))
